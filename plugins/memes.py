...
import asyncio, random, re ,time, requests
...
@plus_ub(pattern=":/", from_users=sudo)
async def kek(keks):
...
@plus_ub(pattern="slap(?: |$)(.*)", from_users=sudo)
async def who(event):
...
@plus_ub(pattern="-_-", from_users=sudo)
async def lol(lel):
...
@plus_ub(pattern="cry", from_users=sudo)
async def cry(e):
    """ y u du dis, i cry everytime !! """
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await e.edit(random.choice(CRI))

@plus_ub(pattern="insult", from_users=sudo)
async def insult(e):
    """ I make you cry !! """
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await e.edit(random.choice(INSULT_STRINGS))

@plus_ub(pattern="cp(?: |$)(.*)", from_users=sudo)
...
@plus_ub(pattern="vapor(?: |$)(.*)", from_users=sudo)
async def vapor(vpr):
    """ Vaporize everything! """
...
@plus_ub(pattern="repo", from_users=sudo)
async def source(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await e.edit("Click [Here](https://github.com/amitsharma123234/Plus) to open this mdafuk'in cool userbot repo .")
			  
			  
@plus_ub(pattern="str(?: |$)(.*)", from_users=sudo)
...
@plus_ub(pattern="zal(?: |$)(.*)", from_users=sudo)
async def zal(zgfy):
...
@plus_ub(pattern="pkill", from_users=sudo)
...
@plus_ub(pattern="bt", from_users=sudo)
...
@plus_ub(pattern="rape", from_users=sudo)
...
@plus_ub(pattern="pru", from_users=sudo)
async def proo (pros):
...
@plus_ub(pattern="fuk", from_users=sudo)
...
@plus_ub(pattern="chu", from_users=sudo)
...
@plus_ub(pattern="thanos", from_users=sudo)
...
@plus_ub(pattern="hardabuse", from_users=sudo)
...
@plus_ub(pattern="gey", from_users=sudo)
...
@plus_ub(pattern="abuse", from_users=sudo)
...
@plus_ub(pattern="owo(?: |$)(.*)", from_users=sudo)
async def faces(owo):
    """ UwU """
...
@plus_ub(pattern="react", from_users=sudo)
...
@plus_ub(pattern="shg", from_users=sudo)
...
@plus_ub(pattern="10iq", from_users=sudo)
async def iqless(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await e.edit("♿")
...
@plus_ub(pattern="mock(?: |$)(.*)", from_users=sudo)
...
@plus_ub(pattern="clap(?: |$)(.*)", from_users=sudo)
...
@plus_ub(pattern="smk (.*)", from_users=sudo)
async def smrk(smk):
...
@plus_ub(pattern="lfy (.*)", from_users=sudo)
