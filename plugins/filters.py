...
@plus_ub(pattern="savefilter (.*)", from_users=sudo)
...
@plus_ub(pattern="listfilters", from_users=sudo)
...
@plus_ub(pattern="clearfilter (.*)", from_users=sudo)
...
@plus_ub(pattern="clearallfilters", from_users=sudo)
