...
@plus.on(events.NewMessage(pattern=r'\#(\S+)', from_users=sudo))
...
@plus_ub(pattern="snips (.*)", from_users=sudo)
...
@plus_ub(pattern="snipl", from_users=sudo)
...
@plus_ub(pattern="snipd (\S+)", from_users=sudo)
