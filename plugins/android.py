...
@plus_ub(pattern="magisk", from_users=sudo)
async def magisk(request):
    ...
    await request.reply(releases, link_preview=False)

@plus_ub(pattern=r"device(?: |$)(\S*)", from_users=sudo)
...
@plus_ub(pattern=r"codename(?: |)([\S]*)(?: |)([\s\S]*)", from_users=sudo)
...
@plus_ub(pattern=r"specs(?: |)([\S]*)(?: |)([\s\S]*)", from_users=sudo)
...
@plus_ub(pattern=r"twrp(?: |$)(\S*)", from_users=sudo)
