...
@plus_ub(pattern="stick ?(?:(.*?) \| )?(.*)", from_users=sudo)
...
async def sticklet(event):
    ...
    await event.client.send_file(event.chat_id, image_stream, caption="Phyco's Sticklet", reply_to=event.message.reply_to_msg_id)
