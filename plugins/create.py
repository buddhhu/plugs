...
@plus_ub(pattern="create (b|g|c)(?: |$)(.*)", from_users=sudo)
    ...
    if not grop.text[0].isalpha() and grop.text[0] not in ("/", "#", "@", "!"):
        ...
        if type_of_group == "b":
            ...
            try:
                ...
                await grop.client.send_message(grop.chat_id, "Your `{}` Group Made Boss!. Join [{}]({})".format(group_name, group_name, result.link), link_preview=False)

            except Exception as e:  # pylint:disable=C0103,W0703

                await grop.client.send_message(grop.chat_id, str(e))
            ...
            try:
                ...
                await grop.client.send_message(grop.chat_id, "Your `{}` Group/Channel Has been made Boss!. Join [{}]({})".format(group_name, group_name, result.link), link_preview=False)
