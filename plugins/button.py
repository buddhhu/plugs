...
@plus_ub(pattern=r"cbutton(?: |$)(.*)", from_users=sudo)
async def _(event):
    chat = event.chat_id
...
CMD_HELP.update({
    ...
    \n**EXAMPLE :** `.cbutton test [google]<buttonurl:https://www.google.com> [Plus Userbot]<buttonurl:https://t.me/plusub:same> [support]<buttonurl:https://t.me/pIusub>`\
    "
})
