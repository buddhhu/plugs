...
@plus_ub(pattern="labstack ?(.*)", from_users=sudo)
async def labstack(event):
    ...
    if input_str:
        ...
        await a.edit("Reply to a media file or provide a directory to upload the file to labstack")
        return
